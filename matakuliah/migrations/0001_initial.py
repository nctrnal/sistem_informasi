    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nama_mata_kuliah', models.CharField(choices=[('Matematika Teknik', 'Matematika Teknik'), ('Sistem Informasi', 'Sistem Informasi'), ('Algoritma Pemrograman', 'Algoritma Pemrograman'), ('Organisasi Arsitektur Komputer', 'Organisasi Arsitektur Komputer'), ('Struktur Data', 'Struktur Data'), ('Desain Web', 'Desain Web')], max_length=100)),
