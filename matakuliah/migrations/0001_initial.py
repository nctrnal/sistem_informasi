    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nama_mata_kuliah', models.CharField(choices=[('Desain Web', 'Desain Web'), ('Organisasi Arsitektur Komputer', 'Organisasi Arsitektur Komputer'), ('Struktur Data', 'Struktur Data'), ('Matematika Teknik', 'Matematika Teknik'), ('Algoritma Pemrograman', 'Algoritma Pemrograman'), ('Sistem Informasi', 'Sistem Informasi')], max_length=100)),
