    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nama_mata_kuliah', models.CharField(choices=[('Matematika Teknik', 'Matematika Teknik'), ('Desain Web', 'Desain Web'), ('Organisasi Arsitektur Komputer', 'Organisasi Arsitektur Komputer'), ('Struktur Data', 'Struktur Data'), ('Sistem Informasi', 'Sistem Informasi'), ('Algoritma Pemrograman', 'Algoritma Pemrograman')], max_length=100)),
